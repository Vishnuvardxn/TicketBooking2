...
import ShowtimeReportPrint from '../components/ShowtimeReportPrint'
...
const Showtime = () => {
	...
	const [showtimeForReport, setShowtimeForReport] = useState(null)
	...
	const handlePrintReport = () => {
		setShowtimeForReport(showtime)
		setTimeout(() => {
			window.print()
			setShowtimeForReport(null)
		}, 100)
	}
	...
	return (
		<>
			<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-indigo-900 to-blue-500 pb-8 print:hidden sm:gap-8">
				<Navbar />
							...
							{auth.role === 'admin' && (
								<>
									<div className="mt-4 flex items-center justify-between">
										<h2 className="text-2xl font-bold">Booked Seats</h2>
										<button
			...
			{showtimeForReport && <ShowtimeReportPrint showtime={showtimeForReport} />}
		</>
	)
}
